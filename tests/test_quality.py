...
class TestComputeQualityScore:
    ...
    def test_with_both_signals(self, sample_paper: Paper) -> None:
        ...
        # boost = 0.2 * 1.0 + 0.2 * 1.0 = 0.4
        # final = 7 * (1 + 0.4) = 9.8
        assert score == pytest.approx(9.8)

    def test_max_boost_is_40_percent(self, sample_paper: Paper) -> None:
        """Test that max boost is 40%."""
...
class TestComputeQualityScores:
    ...
    def test_auto_detects_max_values(self) -> None:
        ...
        # Paper 1 boost = 0.2 * 1.0 = 0.2, final = 5 * 1.2 = 6.0
        # Paper 2 boost = 0.2 * 0.5 = 0.1, final = 5 * 1.1 = 5.5
